...
const Home = () => {
  ...
  const testimonials = [
    {
      ...
      location: 'Jakarta',
      rating: 5,
      comment: 'Sayurannya selalu segar dan berkualitas! Pengiriman juga cepat. Recommended banget!',
  ...
  const generateWhatsAppMessage = (productName, price) => {
    const message = `Halo, saya tertarik dengan ${productName} seharga ${formatPrice(price)}. Mohon info ketersediaan dan cara pemesanannya. Terima kasih!`;
