...
export function generateRandomName() {
  const names = [
    'Budi', 'Siti', 'Ahmad', 'Dewi', 'Andi',
    'Rina', 'Joko', 'Maya', 'Agus', 'Lina'
  ];
  const surnames = [
    'Santoso', 'Wijaya', 'Hidayat', 'Lestari', 'Pratama',
    'Kusuma', 'Wibowo', 'Putra', 'Sari', 'Permana'
  ];
...
export function generateRandomAddress() {
  const streets = [
    ...
    'Jl. Thamrin', 'Jl. Asia Afrika', 'Jl. Diponegoro'
  ];
  const cities = [
    'Jakarta', 'Bandung', 'Surabaya', 'Medan', 'Semarang',
    'Yogyakarta', 'Malang', 'Solo', 'Denpasar', 'Makassar'
  ];
