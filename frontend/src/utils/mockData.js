...
export const mockCategories = [
  {
    ...
    name: "Sayuran",
    slug: "sayuran",
    description: "Sayuran segar dan organik langsung dari petani",
  },
  {
    id: 2,
    name: "Buah-buahan",
    slug: "buah",
    description: "Buah-buahan segar premium pilihan terbaik",
  },
  {
    id: 3,
    name: "Daging & Unggas",
    slug: "daging",
    description: "Daging segar dan unggas berkualitas tinggi",
  },
  {
    id: 4,
    name: "Seafood",
    slug: "seafood",
    description: "Ikan dan seafood segar hasil tangkapan terbaik",
  },
  {
    id: 5,
    name: "Susu & Telur",
    slug: "dairy",
    description: "Produk susu dan telur segar dari peternakan lokal",
  },
];
...
export const mockAuth = {
  login: async (credentials) => {
    ...
    if (
      credentials.email === "admin@baletani.com" &&
      ...
      credentials.email === "customer@baletani.com" &&
