 ...
 * Mendukung navigasi halaman dengan info jumlah data
 */
const Pagination = ({ 
  currentPage, 
  totalPages, 
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="ml-2 block rounded-md border border-gray-300 bg-white py-1 px-2 text-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
          >
